...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public void Shoot() 
        {
            ...
            arrowObject.transform.rotation = Quaternion.Euler(90, arrowObject.transform.rotation.y, arrowObject.transform.rotation.z);
            GameObject arrow = Instantiate(arrowObject, arrowPoint.position, arrowObject.transform.rotation);
